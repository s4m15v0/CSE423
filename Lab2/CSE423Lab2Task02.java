...
public class CSE423Lab2Task02 implements GLEventListener {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        int rem = inp % 10;
        if (rem % 2 == 0){
        	drawMidpointLine(gl, -30, 20, 30, 20);
        	drawMidpointLine(gl, 30, 20, 30, -20);
        	drawMidpointLine(gl, 30, -20, -30, -20);
        	drawMidpointLine(gl, -30, -20, -30, 20);
        	
        	drawMidpointLine(gl, -30, 20, 00, 50);
        	drawMidpointLine(gl, 00, 50, 30, 20);
        	
        	drawMidpointLine(gl, -10, -20, -10, 00);
        	drawMidpointLine(gl, -10, 00, 10, 00);
        	drawMidpointLine(gl, 10, 00, 10, -20);
        }
        else{
        	drawMidpointLine(gl, -50, 00, 50, 00);
        	drawMidpointLine(gl, 50, 00, 40, -20);
        	drawMidpointLine(gl, 40, -20, -40, -20);
        	drawMidpointLine(gl, -40, -20, -50, 00);
        	
        	drawMidpointLine(gl, 00, 00, 00, 75);
        	drawMidpointLine(gl, 00, 75, 20, 00);
        	drawMidpointLine(gl, 00, 50, -20, 00);
        }          	
    ...
    public static void main(String[] args) {
        ...
        CSE423Lab2Task02 t = new CSE423Lab2Task02();
